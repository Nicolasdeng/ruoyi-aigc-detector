...
基于 **RuoYi-Cloud 微服务架构** 开发的 AIGC 内容检测平台，支持文本、图片、视频、语音、论文等 AI 生成内容检测，适合 Java 后端开发者学习 **微服务 + AI 应用开发**。

> 🚀 一个适合写进简历 / 毕业设计 / Java 后端进阶学习的 AI 实战项目。

---

## ✨ 项目亮点

- 🔥 基于 RuoYi-Cloud 二次开发，适合 Java 后端学习者
- 🧠 支持 AIGC 内容检测：文本 / 图片 / 视频 / 论文 / 语音
- 🖼️ 结合 OpenCV + ONNX，预留本地模型推理能力
- 📱 支持 uni-app 小程序端
- 📊 内置检测记录、用户配额、会员订单等业务模块
- 🛡️ 后续规划接入 AI 防诈骗识别能力
- 🎯 适合作为简历项目 / 毕业设计 / 微服务 AI 实战项目

---

## 🧩 项目定位

本项目不是简单的 CRUD 系统，而是一个面向 AI 时代内容安全场景的实战项目。
...
```mermaid
flowchart TD
    A[用户 / 小程序端 uni-app] --> B[网关服务 RuoYi-Gateway]
    C[管理后台 Vue] --> B

    B --> D[认证中心 Auth]
    B --> E[系统服务 System]
    B --> F[AIGC检测服务 AIGC-Service]
